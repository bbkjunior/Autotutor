...
with open ("lyashevskaya_freq_dict_norm.json" , "r", encoding="utf-8") as f:
    ...
    for sentence in text_map:
        ...
        for ind in range (len(sentence['sentence_words'])):
            ...
            try:
                ...
                sentence['words_vectors_list'].append(np.zeros(301).tolist())
                pass
            #raise "stop"
...
def text_features_cal(sentence_map, orig_sentences_list, lemm_sentences_list, raw_text):
    ...
    text_map = OrderedDict([("lix", 0), ("ttr", 0), ("raw_text",[]), ("average_sent_properties",[]),("sentences_map", sentence_map)])
